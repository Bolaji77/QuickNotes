...
function Dashboard() {
  ...
  useEffect(()=>{
    ...
    const unsubscribe = onSnapshot(notesQuery, (QuerySnapshot) =>{
      ...
      setLoading(false);
          ...
          setError("Failed to load notes, please try refreshing the page", err);
          setLoading(false);
    });
      return () => unsubscribe;
  }, [currentUser.uid])
  ...
  return (
    <>
      <div>
        <div className='mb-8'>
          <h3 className='text-2xl font-bold text-gray-900 mb-1'>My Notes</h3>
        ...
        }
        {
          ...
          </div>) : (<div className='text-center py-12 bg-gray-50 rounded-lg border border-gray-100'>
